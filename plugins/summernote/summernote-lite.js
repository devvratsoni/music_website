...
var Style_Style = /*#__PURE__*/function () {
  ...
  Style_createClass(Style, [{
    ...
    value: function styleNodes(rng, options) {
      ...
      var pred = dom.makePredByNodeName(n) {
      $img.off('load').detach();
      deferred.reject($img);
    }).css({
      display: 'none'
...
var Style_Style = /*#__PURE__*/function () {
  ...
  Style_createClass(Style, [{
     ...
     * @private
     * @param  {jQuery} $obj
     * @param  {Array} propertyNames - An array of Left', function (idx, val) {
    ...
    value: function releaseList(clustereds, isEscapseToBody) {
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(clustereds, function (idx, paras) {
        ...
        if (headList.parentNode.nodeName === 'LI') {
          ...
          external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(rootLists, function (idx, root�ist.defineProperty(target, descriptor.key, descriptor); } }
    ...
    value: function indent(editable) {
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(clustereds, function (idx, paras) {
        ...
        if (dom.isLi(head)) {
         ...
         lassCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Table_Table = /*#__PURE__*/function () {
   ...
   *
   * @param {int} rowIndex Index of row to find free space.
   * @param {int} cellIndex Index of cell to find free space in table.rentTr = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(cell).closest('tr');
